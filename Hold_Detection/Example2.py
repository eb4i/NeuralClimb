...
# Uses holdDetector2.py
# Performs 1. Gaussian Blur 2. Converts to Grayscale 3. Canny edge detection (using MEDIAN)
# 4. Contour detection 5. Filters on contours based on area (removing ones too small) 6. Draw

import holdDetector2 as hd
...
# hd.drawCircled(img, holds, contours)
